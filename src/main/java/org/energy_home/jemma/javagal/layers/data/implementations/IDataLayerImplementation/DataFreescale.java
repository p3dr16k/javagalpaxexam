...
public class DataFreescale implements IDataLayer {
	...
	private ArrayBlockingQueue<ByteArrayObject> dataFromSerialComm; //<------------ PATRICK - QUESTA È LA CODA DEI MESSAGGI RICEVUTI!!! 

	public ArrayBlockingQueue<ByteArrayObject> getDataFromSerialComm() {
