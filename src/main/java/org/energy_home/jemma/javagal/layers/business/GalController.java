...
public class GalController {
	...
	public GalController(PropertiesManager _properties) throws Exception {                
		...
		LOG.debug("==================================PAT LOG================================================");
		LOG.debug("Properties manager: " + _properties);
		LOG.debug("Zdo manager: " + zdoManager);
		LOG.debug("aps manager: " + apsManager);
		LOG.debug("Gateway event manager: " + _gatewayEventManager);
		LOG.debug("ManagePanId: " + manageMapPanId);
		LOG.debug("LockerStartDevice: " + _lockerStartDevice);
		LOG.debug("Discovery manager: " + _discoveryManager);
	...
	public void setGatewayEventListener(GatewayEventListener listener, int proxyIdentifier) {
                System.out.println("SET LISTENER, PROXY ID = " + proxyIdentifier);
